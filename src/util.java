...
public class util {
     ...
     * NIM                  : 03081210035
     * Deskripsi Singkat    : (changeToDate) berfungsi untuk mengganti tanggal yang salah menjadi benar
     */
    ...
    /* Nama                 : Lennys Ghitaraj
     * NIM                  : 03081210035
     * Deskripsi Singkat    : (addToDate) berfungsi untuk menambah tanggal dengan durasi (dalam hari)
     */
    ...
    /* Nama                 : Lennys Ghitaraj
     * NIM                  : 03081210035
     * Deskripsi Singkat    : (getDifferenceDays) berfungsi untuk mengembalikan perbedaan 2 tanggal (dalam hari)
     */
    ...
    /* Nama                 : Lennys Ghitaraj
     * NIM                  : 03081210035
     * Deskripsi Singkat    : (updateAll) berfungsi untuk mengupdate arraylist dari file
     */

    public static void updateAll ( ArrayList <Mobil> mobils,ArrayList <TransaksiPeminjaman> pinjams, ArrayList <TransaksiPengembalian> kembalis, ArrayList <Pelanggan> pelanggans, ArrayList<MobilListrik> motors) throws FileNotFoundException, IOException, ParseException{
        ...
        MobilListrik.updateMobilListrik(motors);
    }

    /* Nama                 : Lennys Ghitaraj
     * NIM                  : 03081210035
     * Deskripsi Singkat    : (clearScreen) berfungsi untuk membershkan layar terminal
     */
    ...
    /* Nama                 : Lennys Ghitaraj
     * NIM                  : 03081210035
     * Deskripsi Singkat    : (inputTanggal) berfungsi untuk mengembalikan inputan tanggal dari user
     */
    ...
    /* Nama                 : Lennys Ghitaraj
     * NIM                  : 03081210035
     * Deskripsi Singkat    : (inputDurasi) berfungsi untuk mengembalikan inputan durasi dari user
     */
    ...
    /* Nama                 : Lennys Ghitaraj
     * NIM                  : 03081210035
     * Deskripsi Singkat    : (inputLokasi) berfungsi untuk mengembalikan inputan lokasi dari user
     */
